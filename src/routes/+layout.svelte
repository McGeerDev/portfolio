...
<div class="bg-white min-h-screen text-black font-lekton">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <header class="flex items-center justify-between py-6">
      ...
      <nav class="hidden md:flex items-center space-x-8">
        ...
        <a href="/blog" class="tracking-widest hover:text-gray-600">BLOG</a>
      </nav>
      ...
      <div class="flex items-center space-x-4">
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <!-- GitHub Icon SVG -->
          <svg class="w-6 h-6 hover:text-gray-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="mailto:email@example.com" aria-label="Email">
          <!-- Email Icon SVG -->
          <svg class="w-6 h-6 hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
